...
{
    public string Title { get; init; } = "Database schema";
...
public sealed class DbsViewerClient(HttpClient http)
{
    ...
    {
        System.Net.HttpStatusCode.Forbidden => Texts.Texts.ErrorForbidden,
        System.Net.HttpStatusCode.Unauthorized => Texts.Texts.ErrorUnauthorized,
        System.Net.HttpStatusCode.NotFound => Texts.Texts.ErrorNotFound,
        System.Net.HttpStatusCode.BadRequest => Texts.Texts.ErrorBadRequest,
        _ => string.Format(System.Globalization.CultureInfo.InvariantCulture, Texts.Texts.ErrorStatus, (int)status),
    };
}
